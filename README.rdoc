...
Images should be created to match the three sizes needed by the viewer:

* *large*     : 1000px wide
* *normal*    : 700px wide
* *thumbnail* : 180px wide

The document JSON data should have an image template in the resources.page.image section. The format should match this template:
